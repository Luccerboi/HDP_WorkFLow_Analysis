from ehull_utils import mlip_relax_and_get_energies, mlip_relax_batched, mlip_relax_2step
import pandas as pd
...
mpid_energy_dict = mlip_relax_2step(structure_dict= batch_df['structure'], 
